// <copyright file="CorsTestHostFactory.cs" company="slskdN Team">
...
/// <summary>
/// Test host with CORS enabled and one allowed origin. For PR-04 CORS tests.
/// </summary>
public class CorsTestHostFactory : WebApplicationFactory<ProgramStub>
{
        ...
        return new HostBuilder()
            ...
            .ConfigureWebHostDefaults(web =>
            {
                ...
                web.ConfigureServices(services =>
                {
                    ...
                    services.AddCors(o => o.AddPolicy("ConfiguredCors", b => b
