// <copyright file="HubEnforceAuthTestHostFactory.cs" company="slskdN Team">
...
/// <summary>
/// Test host for PR-02: EnforceSecurity=true, MapHub SearchHub/RelayHub with RequireAuthorization.
/// Anonymous requests to hub negotiate must return 401.
/// </summary>
public class HubEnforceAuthTestHostFactory : WebApplicationFactory<ProgramStub>
{
        ...
        return new HostBuilder()
            ...
            .ConfigureWebHostDefaults(web =>
            {
                ...
                web.Configure(app =>
                {
                    ...
                    app.UseEndpoints(e =>
                    {
                        var search = e.MapHub<SearchHubAuthStub>("/hub/search");
                        search.RequireAuthorization(AuthPolicy.Any);
                        var relay = e.MapHub<RelayHubAuthStub>("/hub/relay");
                        relay.RequireAuthorization(AuthPolicy.Any);
                        e.MapControllers();
                    });
                });
            });
