...
- `slskdn` module uses `https://github.com/snapetech/slskdn/releases/download/2026042900-slskdn.204/slskdn-main-linux-glibc-x64.zip` with sha256.
- Stable releases now publish the Linux glibc x64 asset as `slskdn-main-linux-glibc-x64.zip`. Dev builds use `slskdn-dev-linux-glibc-x64.zip`.
