...
- `slskdn` module uses `https://github.com/snapetech/slskdn/releases/download/0.24.5-slskdn.131/slskdn-main-linux-glibc-x64.zip` with sha256.
- Asset names from the GitHub API can differ from release notes: for `0.24.5-slskdn.131` the Linux x64 asset is `slskdn-main-linux-glibc-x64.zip`. Dev builds use `slskdn-dev-linux-glibc-x64.zip`.
