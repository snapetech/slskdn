...
- `slskdn` module uses `https://github.com/snapetech/slskdn/releases/download/0.24.5-slskdn.117/slskdn-main-linux-x64.zip` with sha256.
- Asset names from the GitHub API can differ from release notes: for `0.24.5-slskdn.117` the Linux x64 asset is `slskdn-main-linux-x64.zip`. Dev builds use `slskdn-dev-linux-x64.zip`.
