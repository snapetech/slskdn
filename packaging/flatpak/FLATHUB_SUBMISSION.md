...
- Asset names from the GitHub API can differ from release notes: for `0.24.5-slskdn.131` the Linux x64 asset is `slskdn-main-linux-x64.zip`. Dev builds use `slskdn-dev-linux-x64.zip`.
