...
# Pre-built zip from GitHub releases (asset slskdn-main-linux-x64.zip). CI overwrites Version and Source0.
Source0:        https://github.com/snapetech/slskdn/releases/download/0.24.5-slskdn.90/slskdn-main-linux-x64.zip
...
%changelog
* Sat Mar 23 2026 snapetech <slskdn@proton.me> - 0.24.5.slskdn.90-1
- Bump to 0.24.5-slskdn.90 (slskdn-main-linux-x64.zip)
