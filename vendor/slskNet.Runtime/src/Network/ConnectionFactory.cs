...
namespace Soulseek.Network
{
    ...
    internal sealed class ConnectionFactory : IConnectionFactory
    {
        ...
        /// <param name="tcpClient">The optional TcpClient instance to use.</param>
        /// <returns>The created connection.</returns>
        public IMessageConnection GetObfuscatedMessageConnection(string username, IPEndPoint ipEndPoint, ConnectionOptions options = null, ITcpClient tcpClient = null) =>
            new MessageConnection(username, ipEndPoint, options ?? new ConnectionOptions(), tcpClient: tcpClient, obfuscated: true);
