...
- Last activity:
  - prepared `2026042900-slskdn.187` as the public stable version format requested for slskdN, avoiding any `0.26` implication while sorting newer than removed `0.25.1-slskdn.*` packages
  ...
  - kept .NET/NuGet build inputs valid by mapping the public release version to `0.0.0-slskdn.2026042900.187` for MSBuild and keeping `InformationalVersion=2026042900-slskdn.187`
...
- Next steps:
  ...
  2. Push tag `build-main-2026042900-slskdn.187` and watch the tag-only release workflow.
