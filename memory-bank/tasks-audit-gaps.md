...
- [ ] **T-1400**: Implement unified BrainzClient
  - Status: Not started
  - Priority: P2
...
- [ ] **T-1401**: Implement full library health scanning
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1402**: Implement library health remediation job execution
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1403**: Complete rescue service implementation
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1404**: Implement swarm download orchestration
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1405**: Implement chunk reassignment logic
  - Status: Not started
  - Priority: P2
  - Branch: experimental/brainz
...
- [ ] **T-1406**: Integrate playback feedback with scheduling
  - Status: Not started
  - Priority: P2
  - Branch: experimental/brainz
...
- [ ] **T-1407**: Implement real buffer tracking
  - Status: Not started
  - Priority: P2
  - Branch: experimental/brainz
...
- [ ] **T-1408**: Implement real search compatibility endpoint
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1409**: Implement real downloads compatibility endpoints
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
...
- [ ] **T-1410**: Add jobs API filtering/pagination/sorting
  - Status: Not started
  - Priority: P3
  - Branch: experimental/brainz
...
- [ ] **T-1421**: Implement real Ed25519 keypair generation
  - Status: Not started
  - Priority: P1
  - Branch: experimental/brainz
