...
Place `SongID` above or beside `MusicBrainzLookup` in [Searches.jsx](/home/keith/Documents/code/slskdn/src/web/src/components/Search/Searches.jsx) and keep the current MusicBrainz panel as the manual fallback.
