...
```bash
wget https://github.com/snapetech/slskdn/releases/download/0.25.1-slskdn.2/install-linux-release.sh
sudo SLSKDN_VERSION=0.25.1-slskdn.2 bash install-linux-release.sh
```
