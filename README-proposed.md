...
We also believe that when users take the time to submit working code, the least a project can do is discuss it.
...
## Quick Start
Getting started is simple. We've removed all the barriers.
...
## Contributing
We welcome contributions from *everyone*—first-timers and veterans alike. No prior relationship required.
...
We believe the best software comes from open collaboration and welcoming feedback from all users—not just those who've contributed code before. Our door is always open for discussion—we find that's how good software gets made.
