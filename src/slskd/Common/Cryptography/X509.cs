// <copyright file="X509.cs" company="slskdN Team">
...
namespace slskd.Cryptography
{
    ...
    public static class X509
    {
        ...
        public static bool TryValidate(string fileName, string? password, out string? result)
        {
            ...
            try
            {
                using var certificate = X509CertificateLoader.LoadPkcs12FromFile(fileName, password, X509KeyStorageFlags.DefaultKeySet, new Pkcs12LoaderLimits());
                return true;
            }
            catch (Exception)
            {
