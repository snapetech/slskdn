// <copyright file="MovieDomainMapping.cs" company="slskdN Team">
...
/// <summary>
///     Utilities for mapping between movie identifiers and domain-neutral Content IDs.
/// </summary>
/// <remarks>
///     Provides deterministic mapping between:
///     - IMDB ID → ContentWorkId
...
public static class MovieDomainMapping
{
    ...
    public static ContentWorkId ImdbIdToContentWorkId(string imdbId)
    {
        ...
        // Normalize IMDB ID (lowercase, ensure 'tt' prefix)
        var normalizedImdbId = imdbId.ToLowerInvariant();
        ...
        var deterministicGuid = GenerateUuidV5(MovieWorkNamespace, normalizedImdbId);
    ...
    public static ContentItemId HashToContentItemId(string hash, long sizeBytes, string? filename = null)
    {
        ...
        // Generate deterministic UUID v5
        var deterministicGuid = GenerateUuidV5(MovieItemNamespace, key);
